...
@NamedQueries({
    ...
    , @NamedQuery(name = "Administratori.findByEmail", query = "SELECT a FROM Administratori a WHERE a.email = :email")
    , @NamedQuery(name = "Administratori.findByLozinka", query = "SELECT a FROM Administratori a WHERE a.lozinka = :lozinka")})
public class Administratori implements Serializable {
    ...
    public Administratori(Integer id, String ime, String prezime, String email, String lozinka) {
        this.id = id;
        this.ime = ime;
    ...
    public String toString() {
        return "model.Administratori[ id=" + id + " ]";
    }
